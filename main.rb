...
player = Player.new
game = Mastermind.new(player, VALID_COLORS, code_length, max_turns)
code_breaker = nil
code_maker = nil
...
if game.choose_game_mode
  ...
  puts
  puts "The computer will be given #{max_turns} attempts. After each "
  ...
  puts '     position.'
  puts
  puts "After #{max_turns} attempts, the computer will be locked out of the system."
...
puts
loop do
  game.setup(code_breaker, code_maker)
